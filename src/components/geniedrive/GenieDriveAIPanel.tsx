...
import { Sparkles, RefreshCw, Copy, Download, Lightbulb, AlertTriangle, CheckCircle, Clock } from 'lucide-react';
...
interface GenieDriveAIPanelProps {
  item: GenieDriveItem;
}

export function GenieDriveAIPanel({ item }: GenieDriveAIPanelProps) {
  ...
  // If no analysis available yet, show generate button
  if (!analysis) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-4">
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        <TabsList className="bg-white px-3 py-2 border-b">
